...
class GameRecommender:
    ...
    def prepare_features(self) -> bool:
        ...
        try:
            ...
            feature_columns = [col for col in self.games_df.columns 
    ...
    def get_recommendations(self, game_id: int, n_recommendations: int = 5) -> List[Dict]:
        """
        ...
        try:
            ...
            similar_indices = similar_indices[similar_indices != game_idx][:n_recommendations]
    ...
    if recommender.train_full_pipeline():
        ...
        if len(recommender.games_df) > 0:
            ...
            for i, rec in enumerate(recommendations, 1):
                logger.info(f"{i}. {rec['name']} (similarity: {rec['similarity_score']:.3f})")
