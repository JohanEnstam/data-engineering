    ...
    try:
        ...
        for result in results:
            ...
            if cover_id and not pd.isna(cover_id):
                result['cover_url'] = f"https://images.igdb.com/igdb/image/upload/t_cover_big/{int(cover_id)}.jpg"
            else:
...
async def get_recommendations(
    ...
    try:
        ...
        for rec in recommendations:
            ...
            if cover_id and not pd.isna(cover_id):
                rec['cover_url'] = f"https://images.igdb.com/igdb/image/upload/t_cover_big/{int(cover_id)}.jpg"
            else:
                rec['cover_url'] = None
...
async def get_game_details(game_id: int) -> Dict:
    ...
    try:
        ...
        return {
            ...
            'cover_url': f"https://images.igdb.com/igdb/image/upload/t_cover_big/{game.get('cover_id', '')}.jpg" if game.get('cover_id') else None
        }
